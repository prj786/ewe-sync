...
<aside class="rail">
  <div class="rail-brand">
    ...
    <div
      ...
      style="background: var(--accent); border-radius: var(--radius-inner)"
    >
      <svg viewBox="0 0 64 64" class="h-6 w-6" fill="var(--accent-fg)">
  ...
  <div class="rail-foot">
    <div class="flex items-center gap-2">
      <span class="h-2 w-2 rounded-full {dotColor[$trayState] || 'bg-[var(--fg-dim)]'}"></span>
      <span class="truncate">
